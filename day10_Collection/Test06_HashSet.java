...
public class Test06_HashSet {
	public static void main(String[] args) {
		...
		//bookList.add(new Book("java", 500)); //add 성공
		...
		//bookList.add(new Book("java", 500)); //add 실패
		
		bookList.add(new Book("spring", 5000));
		bookList.add(new Book("hadoop", 65000));
		bookList.add(new Book("R", 35000)); //add method return type : boolean
		...
		while (it.hasNext()) {
			...
			if(book.title.contains(msg))  {
				System.out.println(book);
				System.out.println("진짜 삭제할까요? y를 입력하면 삭제합니다.");
